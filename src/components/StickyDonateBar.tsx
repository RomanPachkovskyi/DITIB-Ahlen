    ...
    >
      <div className="bg-primary">
        <div className="max-w-5xl mx-auto px-5 md:px-10 h-16 flex items-center justify-center">
          <a
            href="#spenden"
            className="inline-flex items-center gap-2 bg-white hover:bg-white/90 text-primary font-body text-sm font-semibold px-8 py-2.5 rounded-xl transition-colors duration-200 shrink-0"
          >
