...
> ⛔ **ЗАБОРОНЕНО змінювати порти.** Усі три проекти запущені одночасно в Docker.
> Кожен отримав унікальний порт — зміна будь-якого порту зламає паралельну роботу.

| Порт | Проект | Контейнер | Роль |
|------|--------|-----------|------|
| **8082** | **DITIB Ahlen — Лендінг** | `ditib-ahlen-landing` | Vite dev server (React SPA) |
| 8083 | DITIB Ahlen — Портал | `ditib-ahlen-portal` | PHP artisan serve (Laravel) |
| 5173 | DITIB Ahlen — Портал | `ditib-ahlen-portal` | Vite HMR (автоматично з 8083) |
...
1. ⛔ **Порт 8082** — не змінювати. Порт зафіксований щоб не конфліктувати з порталом (8083/5173) та іншими Docker-проектами на цій машині
