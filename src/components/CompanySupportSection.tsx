    ...
    <section className="px-5 py-16 md:px-10 md:py-24">
      <div className="mx-auto max-w-5xl">
        <div ref={headerRef} className="reveal mx-auto mb-12 max-w-3xl text-center md:mb-14">
          <p className="section-label mb-4">— Unterstützung für Unternehmen</p>
          <h2 className="heading-md mb-5 text-foreground">
            Unterstützen Sie das Projekt auf Ihre Weise
          </h2>
          <p className="body-lg">
            Auch Unternehmen können einen wertvollen Beitrag leisten — nicht nur
            durch eine Geldspende, sondern auch durch Sachleistungen,
            Dienstleistungen oder eine individuelle Unterstützungsidee.
          </p>
        </div>
